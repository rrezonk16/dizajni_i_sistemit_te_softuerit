...
<h2 className="text-3xl font-bold mb-8 text-center text-blue-600">Rezervimi u Krye me Sukses!</h2>
...
<p><strong>Statusi i Rezervimit:</strong> {reservationDetails.status}</p>
</div>
<div className="mt-8 text-center">
<QRCodeSVG value={`https://localhost:7117/reservation/${reservationDetails.secretId}`} size={256} />
</div>
<ToastContainer />
</div>
</div>
