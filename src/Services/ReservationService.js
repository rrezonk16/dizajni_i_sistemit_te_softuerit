...
// Get reservation details by secretId
export const getReservationDetails = async (secretId) => {
  try {
    const response = await axios.get(`${API_URL}/details/${secretId}`, { timeout: 5000 });
    return response.data;
  } catch (error) {
